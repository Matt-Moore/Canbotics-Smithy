...
/* SEGMENT PAGES */
app.get('/:langCode(en|fr)/:segmentPage(weapons|weapon|armour|armour)',function(request,response) {
	if (request.params.categoryPage == 'weapons' || request.params.categoryPage == 'armes-de-melee') {
		var detailsPage = dataPage.weapon;
	} else if (request.params.categoryPage == 'armour' || request.params.categoryPage == 'armes-a-distance') {
